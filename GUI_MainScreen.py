...
class MainScreen(tk.Frame):
    ...
    def create_main_menu(self):
        ...
        # 랭크 이미지 추가
        self.kitchen_apprentice = ImageTk.PhotoImage(Image.open("img/chef/kitchen_apprentice-removebg-preview.png"))
        self.canvas.create_window(500, 500, anchor="nw", window=self.kitchen_apprentice)
        self.kitchen_apprentice.place(x= 200, y = 700)
...
class MainScreen(tk.Frame):
    ...
    def create_main_menu(self):
        ...
        for i, img in enumerate(rank_images):
            self.canvas.create_image(200 + (i * 100), 700, anchor="nw", image=img)
